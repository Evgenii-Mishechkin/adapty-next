...
function IconLink({
  ...
  const className =
    "grid h-9 w-9 place-items-center rounded-xl border border-black/10 bg-white text-black/80 shadow-sm transition-colors duration-300 ease-out hover:border-black/20 hover:bg-black/5 hover:text-black";
